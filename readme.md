This GitHub repository contains all the scripts (perl, R, and bash) and programs to reproduce the work done by **Huiying Shang et al. 2021** ("Conserved drivers of genomic landscapes of differentiation 
